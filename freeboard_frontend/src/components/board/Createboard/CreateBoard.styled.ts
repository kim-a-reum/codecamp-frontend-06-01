...
export const NumberValue = styled.input`
  width: 93px;
  height: 50px;
  border: 1px solid gray;
  margin-right: 13px;
`;
export const NumberSearch = styled.div`
  width: 93px;
  height: 50px;
  border: 1px solid gray;
...
export const YoutubeValue = styled.input`
  width: 996px;
  height: 50px;
`;
...
export const FooterPictures = styled.div`
  ...
  height: 118px;
`;
export const PicturesName = styled.div`
  height: 40px;
  font-weight: bold;
`;
...
export const SettingTitle = styled.div`
  ...
  font-weight: bold;
`;
export const SettingChoice = styled.input``;
...
export const FinshButton = styled.button`
  ...
  border: none;
  cursor: pointer;
  background-color: ${(props: IFinshButtonProps) =>
    props.isActive ? "gold" : "gray"};
`;
