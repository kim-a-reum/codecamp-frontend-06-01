...
export default function CallbackPromiseAsyncawaitPage() {
    ...
    return (
        <div>
            <button onClick={onClickCallback}>Callback 요청하기!!</button><br/>

            <button onClick={onClickPromise}>Promise 요청하기!!</button><br/>

            <button onClick={onClickAsyncawait}>Asyncawait 요청하기!!</button><br/>
